...
class MyTrainingArguments(TrainingArguments):
    lora_trainable: Optional[str] = field(default="q_proj,v_proj")
    galore_trainable: Optional[str] = field(default="attn,mlp")
...
def main():
    ...
    if not training_args.full_finetuning:
        if training_args.peft_path is not None:
            ...
            target_modules = training_args.lora_trainable.split(",")
    ...
    # check if the optimizer is from the galore family
    if training_args.optim.name.lower().startswith("galore"):
        training_args.optim_target_modules = training_args.galore_trainable.split(",")
